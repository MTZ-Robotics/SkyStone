...
public class AutoControlsMTZ extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        Boolean oldArm = true;
        autoPaths("Blue","FoundationBridge",oldArm);
    ...
    public void autoPaths(String alliance,String pathToRun,Boolean supportArm) throws InterruptedException {
        ...
        if (pathToRun=="FoundationBridge") {
            ...
            Drive(-24, 0.12, 200);
            Strafe(allianceReverser*12, 0.12, 200);
            Drive(-5, 0.12, 200);
            ...
            Drive(20, 0.2, 200);
            Turn(allianceReverser*-40, 0.2, 200);
            Drive(5, 0.2, 200);
            Turn(allianceReverser*-80, 0.2, 200);
            Strafe(allianceReverser*-5, 0.2, 200);
            Drive(-12, 0.1, 200);
            ...
            //Align to Park
            Strafe(allianceReverser*-8, 0.1, 200);
            Drive(24, 0.1, 200);
